# Auxilio Mecanico FE - Deploy to S3
# Bucket: auxilio-mecanico-fe
# Region: us-east-1

$BucketName = "auxilio-mecanico-fe"
$BuildFolder = "dist/auxilio-mecanico-fe/browser"
$Region = "us-east-1"

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  Auxilio Mecanico FE - Deploy S3" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
